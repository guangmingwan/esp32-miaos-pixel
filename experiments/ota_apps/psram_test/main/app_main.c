...
extern int psram_test_main_impl(int argc, char *argv[]);
...
static void ui_task(void *arg) {
    char *argv[] = {"psram_test"};
    (void)arg;

    psram_test_main_impl(1, argv);
    switch_to_launcher();
    esp_restart();
...
void app_main(void) {
    ...
    xTaskCreatePinnedToCore(ui_task, "psram_test_ui", 32768, NULL, 5, NULL, 1);
}
