...
int main(void) {
    ...
    assert(mia_nes_validate_extension("game.NES") == MIA_NES_OK);
    assert(mia_nes_validate_extension("game.fc") == MIA_NES_OK);
    assert(mia_nes_validate_extension("game.fds") == MIA_NES_OK);
    assert(mia_nes_validate_extension("game.nsf") == MIA_NES_OK);
    assert(mia_nes_validate_extension("game.zip") == MIA_NES_OK);
