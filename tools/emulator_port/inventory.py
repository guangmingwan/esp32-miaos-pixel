...
TARGETS: Final[tuple[Target, ...]] = (
    target("nes", ManifestCategory.EMULATORS, "nes", (), "retro-core/nofrendo", ("nes", "fc", "fds", "nsf", "zip"), Geometry(256, 240), 32000, (req("bios", "/bios/fds_bios.bin", False, "Required only for FDS images."),), ("retro-core/main/main_nes.c", "retro-core/components/nofrendo"), (BASE, BSD_NES)),
    target("snes", ManifestCategory.EMULATORS, "snes", (), "retro-core/snes9x", ("smc", "sfc", "zip"), Geometry(256, 224), 32000, (), ("retro-core/main/main_snes.c", "retro-core/components/snes9x"), (BASE, SNES9X)),
    target("gb", ManifestCategory.EMULATORS, "gb", (), "retro-core/gnuboy", ("gb", "gbc", "zip"), Geometry(160, 144), 32000, (req("bios", "/bios/gb_bios.bin", False, "Optional boot ROM; never bundled."),), ("retro-core/main/main_gbc.c", "retro-core/components/gnuboy"), (BASE, BSD_GB)),
    target("gbc", ManifestCategory.EMULATORS, "gbc", (), "retro-core/gnuboy", ("gbc", "gb", "zip"), Geometry(160, 144), 32000, (req("bios", "/bios/gbc_bios.bin", False, "Optional boot ROM; never bundled."),), ("retro-core/main/main_gbc.c", "retro-core/components/gnuboy"), (BASE, BSD_GB)),
    ...
    target("sms", ManifestCategory.EMULATORS, "sms", (), "retro-core/smsplus", ("sms", "sg", "zip"), Geometry(256, 192), 32000, (), ("retro-core/main/main_sms.c", "retro-core/components/smsplus"), (BASE, BSD_SMS)),
    target("gg", ManifestCategory.EMULATORS, "gg", (), "retro-core/smsplus", ("gg", "zip"), Geometry(160, 144), 32000, (), ("retro-core/main/main_sms.c", "retro-core/components/smsplus"), (BASE, BSD_SMS)),
    target("coleco", ManifestCategory.EMULATORS, "col", ("col",), "retro-core/smsplus", ("col", "rom", "zip"), Geometry(256, 192), 32000, (), ("retro-core/main/main_sms.c", "retro-core/components/smsplus"), (BASE, BSD_SMS), rom_directory="col"),
    target("pce", ManifestCategory.EMULATORS, "pce", (), "retro-core/pce-go", ("pce", "zip"), Geometry(256, 224), 22050, (), ("retro-core/main/main_pce.c", "retro-core/components/pce-go"), (BASE, BSD_PCE)),
    target("lynx", ManifestCategory.EMULATORS, "lnx", ("lnx",), "retro-core/handy", ("lnx", "zip"), Geometry(160, 102), 32000, (), ("retro-core/main/main_lynx.cpp", "retro-core/components/handy"), (BASE,), rom_directory="lnx"),
    ...
    target("megadrive", ManifestCategory.EMULATORS, "gwenesis", ("md", "genesis"), "gwenesis", ("md", "gen", "bin", "smd", "zip"), Geometry(320, 224), 26633, (), ("gwenesis/main/main.c", "gwenesis/components/gwenesis"), (BASE, GWENESIS), rom_directory="md"),
