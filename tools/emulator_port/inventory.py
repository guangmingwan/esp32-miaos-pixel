...
TARGETS: Final[tuple[Target, ...]] = (
    ...
    target("gba", ManifestCategory.EMULATORS, "gba", (), "gbsp", ("gba",), Geometry(240, 160), 32000, (req("bios", "/bios/gba_bios.bin", True, "GBA BIOS is required and not bundled."),), ("gbsp",), (BASE,)),
